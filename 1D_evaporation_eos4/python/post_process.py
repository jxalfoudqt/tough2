...
while i<lst.num_times:
    ...
    ax7.set_xscale('log')
    ax8 = ax7.twinx() 
    ax8.plot(lst.times[:i+1]*dayPs,vapor_adv_flow_second_mmPday[:i+1],'r1-',)
    #plt.ylim(-1.3e-1,-6e-2)
    ...
    ax7=plt.subplot(816)
    ax7.plot(lst.times[:i+1]*dayPs,vapor_flow_second_mmPday[:i+1],'k1-')
    plt.ylabel('Vapor Velocity\n2nd (mm/day)')
    #plt.xlabel('Time (day)')
    #plt.ylim(-0.1e-3,0.11e-2)
    ...
    ax7.set_xscale('log')
    ax8 = ax7.twinx() 
    ax8.plot(lst.times[:i+1]*dayPs,liquid_flow_second_mmPday[:i+1],'r1-',)
    #plt.ylim(-1.e1,1.1e2)
