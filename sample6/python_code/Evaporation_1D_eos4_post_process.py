...
while i<lst.num_times:
    ...
    fig=plt.figure()
    ax1=plt.subplot(141)
    ax1.plot(Gas_Pressure/1000, element,'b-')
    ...
    #ax1.set_xscale('log')
    ax2=ax1.twiny()
    ax2.plot(Capillary_Pressure/1000,element,'r-')
    ...
    ### saturation
    plt.subplot(142)
    plt.plot(Liq_saturation*100,element,'b-')
    plt.xlabel('Liq. sat. (%)')
    # plt.ylabel('high (m)')
    plt.ylim(7,0)
    ...
    ax3=plt.subplot(143)
    ax3.plot(Liquid_flow_raw,connection,'b-')
    ...
    ax3=plt.subplot(144)
    ax3.plot(Gas_flow_raw,connection,'b-')
