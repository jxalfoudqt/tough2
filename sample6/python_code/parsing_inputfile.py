...
fig=plt.figure()
ax1=plt.subplot(141)
ax1.plot(initial_porosity[:],element_location[:,0],'b1-')
plt.xlabel('Por.')
plt.ylabel('x (m)')
# plt.ylabel('high (m)')
plt.ylim(7,0)
...
ax2=plt.subplot(142)
ax2.plot(initial_condition[:,0]/1000,element_location[:,0],'b1-')
...
ax3=plt.subplot(143)
ax3.plot(100-initial_condition[1:,1]*100,element_location[1:,0],'b1-')
plt.xlabel('Liq. Sat. (%)')
# plt.ylabel('high (m)')
plt.ylim(7,0)
...
ax4=plt.subplot(144)
ax4.plot(initial_condition[:,2]/1000,element_location[:,0],'b1-')
plt.xlabel('Air Pre. (%)')
# plt.ylabel('high (m)')
plt.ylim(7,0)
# plt.xlim(np.nanmin(Gas_flow),np.nanmax(Gas_flow))	
