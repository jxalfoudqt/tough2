...
for i in dat.grid.rocktype:
    ...
    ax3.plot(saturation*100,capillary_pressure,'k-o',)
    ...
    ax1.plot(saturation*100,liquid_relative_permeability,'k-o',)
    plt.xlabel('saturation (%)')
    ...
    #ax1.set_yscale('log')
    ax2=ax1.twinx()
    ax2.plot(saturation*100,gas_relative_permeability,'r-o',)
    plt.xlabel('saturation (%)')
