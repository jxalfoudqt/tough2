...
diffusion_calculation_chenming                   = porosity**(4./3)*(gas_saturation)**(10./3)*gas_density_kgPm3*diffusion_coefficient*vapor_density_gradient_chenming*dat.grid.connectionlist[0].area
